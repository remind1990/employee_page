...
const StartNowBox = (props: Props) => {
  return (
    <div className='flex-column z-10 mx-auto w-[90%] max-w-[450px] animate-attractAttention gap-4 rounded-xl bg-gradient-to-t from-stone-700 to-stone-900 px-6 py-6 shadow-levitate md:mx-0'>
      <Logo />
